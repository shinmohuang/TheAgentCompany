...
docker pull docker.io/bitnamilegacy/mongodb:5.0
...
docker run -d \
    ...
    --network host \
    --restart always \
    -e ROCKETCHAT_PORT=3002 \
    -v /var/run/docker.sock:/var/run/docker.sock \
    ghcr.io/theagentcompany/servers-api-server:latest

# Fix MongoDB image name in docker-compose.yml
echo "Fixing MongoDB image name in docker-compose.yml..."
docker exec api-server sed -i 's|docker.io/bitnami/mongodb:|docker.io/bitnamilegacy/mongodb:|g' /workspace/docker-compose.yml
