# How to run
Try make `start-rocketchat` under server directory. It will start at `http://localhost:3002` which is `http://ogma.lti.cs.cmu.edu:3002/` when you launch in server.
