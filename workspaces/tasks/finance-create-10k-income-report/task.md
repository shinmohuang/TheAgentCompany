...
Once that is compiled send the path of this table to David Wong, the head of finance on Rocketchat - http://the-agent-company.com:3002/. With this, suggest to him which company we should invest in based on the company that had the largest percentage growth in net income between 2022-2023.
