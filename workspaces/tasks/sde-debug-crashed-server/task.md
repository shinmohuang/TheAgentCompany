...
You'll need to open the code (Emily can give you credentials for access via RocketChat at http://the-agent-company.com:3002), figure out what's wrong, and modify the code so it doesn't crash anymore.
